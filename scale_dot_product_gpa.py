...
# code taken from https://github.com/rmaestre/transformers_path_search/blob/main/src/scale_dot_product_gpa.py,
# in turn citing https://github.com/fkodom/grouped-query-attention-pytorch/blob/main/grouped_query_attention_pytorch/attention.py
